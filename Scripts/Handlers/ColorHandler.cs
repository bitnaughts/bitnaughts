...
public class Formatter {
    ...
    //Color schemes:::
    public static Color Color_keyword = new Color (88, 156, 214);
    public static Color Color_variable = new Color (156, 220, 254);
    public static Color Color_object = new Color (80, 200, 175);
    public static Color Color_function = new Color (220, 220, 170);
    public static Color Color_number = new Color (181, 206, 168);
    public static Color Color_comment = new Color (88, 166, 77);
    public static Color Color_string = new Color (210, 150, 100);
    public static Color Color_highlight = new Color (1, 0, 0);

    public static Color Color_shadedScreen = new Color (16, 46, 51);
    public static Color Color_screen = new Color (25, 61, 65);
    public static Color Color_litScreen = new Color (34, 76, 79);
